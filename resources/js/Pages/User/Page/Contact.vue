...
<template>
    <UserLayouts>
        <section>
            <div id="contact" class="py-8 px-4 mx-auto max-w-screen-xl text-center lg:py-16 lg:px-12">
                <h1
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 mt-8">
                    ...
                    <form class="p-6 flex flex-col justify-center">
                        ...
                        <button type="submit"
                            class="md:w-32 hover:bg-gradient-to-bl text-white bg-gradient-to-r from-cyan-500 to-blue-500 font-bold py-3 px-6 rounded-lg mt-3 hover:bg-blue-800 transition ease-in-out duration-300">
                            Submit
                        </button>
                    </form>
                </div>
